...
### Distance of code $G$.
- $d = \min\limits_{x\in F^n\text{\textbackslash} \{0\}} \Vert Gx \Vert_0$. where $\Vert Gx \Vert_0$ denotes the number of nonzero entries in $Gx \in F^m$.
...
## Important
- Choosing the elements $m, n, S, F, d$ can influence the formation of different codes.
